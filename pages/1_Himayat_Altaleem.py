...
<div class="big-card-wrap">
  ...
  تعزيز وعي الطالبات بحق التعليم وحمايته في أوقات النزاع.
ترسيخ قيم السلام والعدالة وحقوق الإنسان.
تنمية المواطنة العالمية والمسؤولية الأخلاقية.
دعم التعبير الآمن والواعي عن التضامن الإنساني.
إشراك المجتمع المدرسي في مبادرات داعمة للقيم الإنسانية.
  </p>
</div>
""",
        unsafe_allow_html=True,
...
<div class="big-card-wrap">
  ...
  <p class="big-card-text">
    إذاعة مدرسية ورسائل صباحية عن “التعليم حق”.
ركن توعوي/لوحات: حق التعليم + حماية المدارس.
حصص/أنشطة صفية: قصص قصيرة، قراءة نصوص، كتابة رسائل سلام.
معرض فني: “لا للهجمات على المدارس” + “فلسطين في قلوبنا” (ضمن ضوابط المدرسة).
  </p>
</div>
""",
        unsafe_allow_html=True,
